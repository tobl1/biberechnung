...
export const THEMES: Record<string, { label: string; hint: string; preview: string }> = {
  light: { label: 'Hell',   hint: 'Klares Glas',       preview: 'linear-gradient(135deg, #f7faf7, #cfeedd)' },
  dark:  { label: 'Dunkel', hint: 'Dunkles Glas',      preview: 'linear-gradient(135deg, #16261f, #0b1612)' },
  grain: { label: 'Körnig', hint: 'Pastell, Airbrush', preview: 'linear-gradient(135deg, #fbd9b5, #b9b0f0)' },
}
